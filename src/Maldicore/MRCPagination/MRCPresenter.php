<?php namespace Maldicore\MRCPagination;

use Illuminate\Pagination\BootstrapPresenter;

class MRCPresenter extends BootstrapPresenter {
    ...
    public function getPrevious($text = '&laquo;')
    {
        ...
        {
            return '<li class="prev disabled"><a href="#">'.$text.'</a></li>';
        }
        else
        {
            $url = $this->paginator->getUrl($this->currentPage - 1);

            return '<li class="prev"><a href="'.$url.'">'.$text.'</a></li>';
        }
    }
    ...
    public function getNext($text = '&raquo;')
    {
        ...
        {
            return '<li class="next disabled"><a href="#">'.$text.'</a></li>';
        }
        else
        {
            $url = $this->paginator->getUrl($this->currentPage + 1);
